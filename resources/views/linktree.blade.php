...
<head>
  ...
  <link rel="stylesheet" href="{{asset('assets/linktree/ivenastyles.css')}}">
...
<body>
  <div class="ivena-container">
    <div class="ivena-image-container">
      <img class="ivena-logo" src="https://ugc.production.linktr.ee/mBOmfyudRti5J91kKQoa_AV3Ts6FSP8JIeFG5?io=true&size=avatar-v1" alt="Logo Cali" />
      <h1>@cafecali.jkt</h1>
    </div>

    <div class="ivena-links-container">
        <div class="ivena-links">
        <a class="ivena-button-container" href="https://drive.google.com/file/d/14WKfabO9rq9d39nI7zIBmMxGGV0QZPAd/view" target="_blank">
            <p>Dining</p>
        </a>
        </div>
    </div>
    <div class="ivena-links-container">
        <div class="ivena-links">
        <a class="ivena-button-container" href="https://drive.google.com/file/d/1T8gfepVbyDXJ4Ea3Z-A3nrtZmwzaCBKm/view" target="_blank">
            <p>Shisa</p>
        </a>
        </div>
    </div>
    <div class="ivena-links-container">
        <div class="ivena-links">
        <a class="ivena-button-container" href="https://drive.google.com/file/d/1kpt6XtjrjX2BrN_AspmgHrcNRVJvQ26q/view" target="_blank">
    ...
    <div class="ivena-links-container">
        <div class="ivena-links">
        <a class="ivena-button-container" href="https://drive.google.com/file/d/1bRt8GkrqeyX3CYh1-SdPH3pgKXQ_lpf1/view" target="_blank">
    ...
    <div class="ivena-links-container">
        <div class="ivena-links">
        <a class="ivena-button-container" href="https://drive.google.com/file/d/1OLmtJnb1tMu1miNGKkN1nTqi9tmljUDU/view" target="_blank">
            <p>A-Z Gin & Tonic</p>
        </a>
        </div>
    </div>
    <div class="ivena-links-container">
        <div class="ivena-links">
        <a class="ivena-button-container" href="https://drive.google.com/file/d/1zqAtqu_MAlngx_EEaDbGg8Z0HrTJUh9z/view" target="_blank">
            <p>Cocktails</p>
        </a>
        </div>
    </div>
    <div class="ivena-links-container">
        <div class="ivena-links">
        <a class="ivena-button-container" href="https://drive.google.com/file/d/1po2maqseAxkQAfxemcC-uyZspNCowt2Q/view" target="_blank">
            <p>Wine List</p>
        </a>
        </div>
    </div>
    <div class="ivena-links-container">
        <div class="ivena-links">
        <a class="ivena-button-container" href="https://api.whatsapp.com/send/?phone=%2B6287776545223&text&type=phone_number&app_absent=0" target="_blank">
            <p>WhatsApp</p>
        </a>
        </div>
    </div>
...
">
    <a
      href="https://linktr.ee/?utm_source=linktree&utm_medium=profile&utm_content=hokbenid"
      ><svg
        height="110px"
        viewBox="0 0 80 17"
