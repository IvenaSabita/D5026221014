                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laravel.com/docs"
                                    class="underline text-gray-900 dark:text-white">Kampus ITS</a></div>
                        </div>
                        ...
                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                               ...
                               <div class="text-lg leading-10 font-light"><a href="/ETS"
                                class="dark:text-white">Website ETS</a></div>
                                <div class="text-lg leading-10 font-light"><a href="/latihan1"
                                class="dark:text-white">Tugas Duplikasi 1</a></div>
                                <div class="text-lg leading-10 font-light"><a href="/linktree"
                                class="dark:text-white">Tugas Duplikasi Linktree</a></div>
                                <div class="text-lg leading-10 font-light"><a href="/cobaJS"
                                class="dark:text-white">JavaScript 1</a></div>
                                <div class="text-lg leading-10 font-light"><a href="/cobaJS2"
